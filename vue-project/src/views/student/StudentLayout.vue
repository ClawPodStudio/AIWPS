      ...
      <el-header>
        ...
        <div class="header-right">
          <el-dropdown @command="handleCommand">
            <span class="user-info"><el-icon><User /></el-icon><span class="user-name">{{ userStore.userInfo.name||'学生' }}</span></span>
            <template #dropdown>
...
import { HomeFilled, Edit, Warning, Reading, Timer, User, Fold } from '@element-plus/icons-vue'
...
.desktop-sidebar{background:#304156;color:#fff}
...
.el-header{background:#fff;display:flex;align-items:center;justify-content:space-between;padding:0 20px;box-shadow:0 1px 4px rgba(0,0,0,.08)}
